...
from ._route_predicate import (
    ...
    # 34-cell route-OUT (20th-slot).  Cohort geomean 1.456× per K-1711
    # paired n=30 HIP-graph audit.
...
def _k971_route_to_hbl(M, N, K, a_dtype, b_dtype, enable_streamk, work_stealing):
    ...
    # K-1720 P30 (20th-slot): skinny_Nmid (N ∈ {384, 768, 1536})
    # K-COMPLEMENT 34-cell route-OUT.  Closes the K-1711 cross-N
    # envelope-stitching gap; cohort geomean 1.456×.
