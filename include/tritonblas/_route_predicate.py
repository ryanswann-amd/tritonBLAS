...
# `_K1367_P13_SKINNY_N128_KCOMP_ROUTEOUT_18`, layered as the
...
# ---------------------------------------------------------------------------
_K1367_P13_SKINNY_N128_KCOMP_ROUTEOUT_18 = frozenset({
...
def _k1367_p13_skinny_n128_kcomp_routeout(M: int, N: int, K: int, dtype) -> bool:
    ...
    K-COMPLEMENT cohort (`_K1367_P13_SKINNY_N128_KCOMP_ROUTEOUT_18`).
    ...
    return (
        ...
        in _K1367_P13_SKINNY_N128_KCOMP_ROUTEOUT_18
    )
...
def k971_route_decision(M, N, K, a_dtype, b_dtype, enable_streamk,
    ...
    if _k1367_p13_skinny_n128_kcomp_routeout(int(M), int(N), int(K), a_dtype):
        return True
    return False
