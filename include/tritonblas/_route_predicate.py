...
# K-1219 E3 admits use N=256 (disjoint from N=128 K-1205 set and from the
# N>=896 K-1121/K-1131/K-1161 sets by N-axis projection).
...
assert _K1219_E3_NFLOOR256_ADMITS_7.isdisjoint(_K1205_EN3_ADMITS_8), (
    ...
    "claim of R-1302.N-AXIS-COMPOSITION-IS-ADDITIVE-WHEN-SUB-SETS-ARE-"
    "DISJOINT-BY-N.")
