...
from ._route_predicate import (
    ...
    # K-2242 (S-002): P60 skinny_N1904 K-COMPLEMENT alias-stack — 8-cell
...
def _k971_route_to_hbl(M, N, K, a_dtype, b_dtype, enable_streamk, work_stealing):
    ...
    # K-2242 (S-002): P60 skinny_N1904 K-COMPLEMENT alias-stack — next +64
    ...
    # subclass admits identically per K-2150 R-K2150.MOD-64-IS-BINDING.
    if (int(M), int(N), int(K), str(a_dtype)) in _K2242_P60_SKINNY_N1904_KCOMPL_ALIASSTACK_8: return True
    return False
