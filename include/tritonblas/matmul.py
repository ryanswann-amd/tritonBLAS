...
def _k971_route_to_hbl(M, N, K, a_dtype, b_dtype, enable_streamk, work_stealing):
    ...
    # T1/T2 = (2048^3 bf16/fp16) LDS-BC bound (K-877 S1a/S1b direct PMC);
    # T3 = (4096^3 bf16) VALU-packing dispatch over-launch (K-1345 5-anchor
    # triangulated). 8192^3 bf16 deliberately DROPPED (K-1308 F4 row 7,
    # HBM-asymptote-bound). Disjoint with K-1322 P8 + K-1338 by construction.
