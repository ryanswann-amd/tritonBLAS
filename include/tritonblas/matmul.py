...
from ._route_predicate import (
    ...
    # K-2214 (S-002): P58 skinny_N1776 K-COMPLEMENT alias-stack — 10-cell
...
def _k971_route_to_hbl(M, N, K, a_dtype, b_dtype, enable_streamk, work_stealing):
    ...
    # K-2214 (S-002): P58 skinny_N1776 K-COMPLEMENT alias-stack — next +64
    ...
    # 10 cells (9 bf16: M ∈ {2048,4096,8192} × N=1776 × K ∈ {4096,8192,16384}
    # + 1 fp16 spot at M=4096, K=8192) — task-specified verification cohort,
    # not the full 18-cell envelope.  Same off-by-48 wave-misalignment
    # mechanism as every prior rung (BLOCK_N=128 → 13.875 fractional tiles
