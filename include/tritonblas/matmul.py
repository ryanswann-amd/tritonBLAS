...
from ._route_predicate import (
    ...
    # K-2206 (S-002): P58 skinny_N1776 K-COMPLEMENT alias-stack — 8-cell
    # 15th-rung extension of the off-by-48 wave-misaligned ladder
    # (mod-64=48, mod-128=112).  Disjoint with every prior slot (no shared
    # N).  Branched off fix/K-2183@9375e7a.
    _K2206_P58_SKINNY_N1776_KCOMPL_ALIASSTACK_8,
)
...
def _k971_route_to_hbl(M, N, K, a_dtype, b_dtype, enable_streamk, work_stealing):
    ...
    # K-2206 (S-002): P58 skinny_N1776 K-COMPLEMENT alias-stack — next +64
    ...
    # subclass admits identically per K-2150 R-K2150.MOD-64-IS-BINDING.
    if (int(M), int(N), int(K), str(a_dtype)) in _K2206_P58_SKINNY_N1776_KCOMPL_ALIASSTACK_8: return True
    return False
