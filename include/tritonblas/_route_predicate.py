...
# K-2127 (S-002): P54 (next-position) skinny_N1456 K-COMPLEMENT alias-stack —
# 18-cell verified-winner subset for the off-by-48 wave-misaligned N=1456
# **11th-rung extension** of the contiguous off-by-48 ladder admitted across
...
# K-2055/K-2060/K-2063/K-2066 (P49 N=1136), K-2071/K-2075/K-2077/K-2085 (P50
# N=1200), K-2071/K-2085/K-2091 (P51 N=1264), K-2092/K-2101/K-2106 (P52
# N=1328) and K-2107 (P53 N=1392).  N=1456 carries (mod 64 = 48, mod 128 =
# 48) — same off-by-48 wave-misalignment band as every prior rung of this
# family.  The K-COMPLEMENT swap recovers wave-tile coverage at residue-48
# by reorienting the inner-K reduction so the per-tile schedule no longer
...
# (M=4096, K=8192, bf16); K-2091 4th-independent confirmation at N=1264 and
# K-2107 6th-independent confirmation at N=1392 wall-clock refuted the
# K-2061 PMC-derived family ceiling.  K-2127 extends that ladder by one
# rung per the K-2072 wide-N admit-eligible-past-N=1776 prediction.  Per
# K-2107 K-axis amplification slope, expected worst-cell (M=4096, N=1456,
# K=16384) BEFORE TB/HBL projects in the 1.7×–1.9× range (using K-2101 +
# K-2107 refined projection, not K-2091 N=1264 single-rung extrapolation).
#
...
# single hash lookup (~30 ns on Zen3) per dispatch — equivalent to the 10
# prior off-by-48 rungs already in the alias-stack.
_K2127_P54_SKINNY_N1456_KCOMPL_ALIASSTACK_18 = frozenset(
...
# K-2183 (S-002): P57 (next-position) skinny_N1712 K-COMPLEMENT alias-stack —
...
# K-2158 (P55 N=1584) and K-2169 (P56 N=1648).
# N=1712 carries (mod 64 = 48, mod 128 = 48) — same off-by-48 wave-
# misalignment band as every prior rung of this family.  The K-COMPLEMENT
# swap recovers wave-tile coverage at residue-48 by reorienting the inner-K
# reduction so the per-tile schedule no longer strands a 48-element wave-
# misaligned N-fragment per BLOCK_N=128 tile (N=1712 = 13.375 fractional
# tiles per N-row, vs N=1648's 12.875 / N=1584's 12.375 / N=1456's
# 11.375).  Per K-2150 R-K2150.MOD-64-IS-BINDING-MOD-128-IS-NOT-FOR-
# RESIDUE-48-FAMILY only `mod 64 == 48` binds — the `mod 128 == 48`
# subclass at N=1712 admits identically (validated upstream at K-1978
# N=816 / K-2010-2024 N=944 / K-2043-2052 N=1072 / K-2092-2106 N=1328 /
# K-2158 N=1584 — all `mod 128 == 48`).
#
# Mechanism (R-1811 wave-misalignment + K-913 §3 LDS-bank-conflict): same
# SCHEDULER_LDS A4 failure mode as every prior off-by-48 rung; per K-2061
# PMC delta-attribution residue-48 carries a stable LDS bank-conflict
# differential (~6×) vs residue-32 (~2×) and wave-aligned (~1×) at
# (M=4096, K=8192, bf16).  K-2183 paired n=30 HIP-graph hot-cache 3-engine
# bench (tb / hbl / rocblas) on the task-specified 8-cell verification
# cohort (M ∈ {4096,8192} × N=1712 × K ∈ {8192,16384} × {bf16,fp16})
# extends the K-2169 13-rung wall-clock chain by one residue-48 step
# (+64 from N=1648 on the same residue-48 lattice).  The frozenset literal
# cardinality (==8) matches the measured verification cohort, not the
# canonical 18-cell envelope — extension to the full grid is deferred to
# a follow-up rung-stitch task.
#
# Naturally disjoint with every prior K-COMPLEMENT alias-stack slot (no
# shared N).  +2 active LOC additive in the dispatcher (1 import in
# matmul.py + 1 membership-check); cold-path latency impact bounded by a
...
# prior off-by-48 rungs already in the alias-stack.
_K2183_P57_SKINNY_N1712_KCOMPL_ALIASSTACK_8 = frozenset(
    (M, 1712, K, dt) for M in (4096, 8192)
    for K in (8192, 16384) for dt in ("torch.bfloat16", "torch.float16")
)
# Cardinality (==8) gated by tests/test_k2183_p57_n1712_skinny_kcompl.py
# per the minimalist split: src holds data, tests hold invariants
# (R-1532 / R-1720 / R-1775).

# K-2203 (S-002): P58 (next-position) skinny_N1776 K-COMPLEMENT alias-stack —
# 8-cell verified-winner subset for the off-by-48 wave-misaligned N=1776
# **15th-rung extension** of the contiguous off-by-48 ladder admitted across
# K-1978 (P45 N=816), K-1990/K-1994 (N=880), K-2010/K-2014/K-2024 (P46
# N=944), K-2031/K-2036/K-2041 (P47 N=1008), K-2043/K-2047/K-2052 (P48
# N=1072), K-2055/K-2060/K-2063/K-2066 (P49 N=1136), K-2071/K-2075/K-2077/
# K-2085 (P50 N=1200), K-2071/K-2085/K-2091 (P51 N=1264), K-2092/K-2101/
# K-2106 (P52 N=1328), K-2107 (P53 N=1392), K-2127 (P54 N=1456),
# K-2158 (P55 N=1584), K-2169 (P56 N=1648) and K-2183 (P57 N=1712).
...
# tiles per N-row, vs N=1712's 13.375 / N=1648's 12.875 / N=1584's 12.375).
# Per K-2150 R-K2150.MOD-64-IS-BINDING-MOD-128-IS-NOT-FOR-RESIDUE-48-FAMILY
# only `mod 64 == 48` binds — the `mod 128 == 112` subclass at N=1776
# admits identically (validated upstream at K-2055-2066 N=1136 / K-2071-
# 2091 N=1200 / K-2071-2091 N=1264 / K-2169 N=1648 — all `mod 128 == 112`).
#
# Mechanism (R-1811 wave-misalignment + K-913 §3 LDS-bank-conflict): same
# SCHEDULER_LDS A4 failure mode as every prior off-by-48 rung; per K-2061
# PMC delta-attribution residue-48 carries a stable LDS bank-conflict
# differential (~6×) vs residue-32 (~2×) and wave-aligned (~1×) at
# (M=4096, K=8192, bf16).  K-2164 PMC delta-attribution sweep already
# profiled N=1776 across the residue-48 ladder upper-bound and confirmed
# the LDS_BC_per_LDS_inst (88.7%) and LDS_WAIT_per_LDS_inst signatures
# persist at this rung.  K-2203 paired n=30 HIP-graph hot-cache 3-engine
# bench (tb / hbl / rocblas) on the task-specified 8-cell verification
# cohort (M ∈ {4096,8192} × N=1776 × K ∈ {8192,16384} × {bf16,fp16})
# extends the K-2183 14-rung wall-clock chain by one residue-48 step
# (+64 from N=1712 on the same residue-48 lattice).  The frozenset literal
# cardinality (==8) matches the measured verification cohort, not the
# canonical 18-cell envelope — extension to the full grid is deferred to
# a follow-up rung-stitch task.
#
...
# prior off-by-48 rungs already in the alias-stack.
_K2203_P58_SKINNY_N1776_KCOMPL_ALIASSTACK_8 = frozenset(
    (M, 1776, K, dt) for M in (4096, 8192)
    for K in (8192, 16384) for dt in ("torch.bfloat16", "torch.float16")
)
# Cardinality (==8) gated by tests/test_k2203_p58_n1776_skinny_kcompl.py
# per the minimalist split: src holds data, tests hold invariants
# (R-1532 / R-1720 / R-1775).

# K-2223 (S-002): P59 (next-position) skinny_N1840 K-COMPLEMENT alias-stack —
# 8-cell verified-winner subset for the off-by-48 wave-misaligned N=1840
# **16th-rung extension** of the contiguous off-by-48 ladder admitted across
# K-1978 (P45 N=816), K-1990/K-1994 (N=880), K-2010/K-2014/K-2024 (P46
# N=944), K-2031/K-2036/K-2041 (P47 N=1008), K-2043/K-2047/K-2052 (P48
# N=1072), K-2055/K-2060/K-2063/K-2066 (P49 N=1136), K-2071/K-2075/K-2077/
# K-2085 (P50 N=1200), K-2071/K-2085/K-2091 (P51 N=1264), K-2092/K-2101/
# K-2106 (P52 N=1328), K-2107 (P53 N=1392), K-2127 (P54 N=1456),
# K-2158 (P55 N=1584), K-2169 (P56 N=1648), K-2183 (P57 N=1712) and
# K-2203 (P58 N=1776).
# N=1840 carries (mod 64 = 48, mod 128 = 48) — same off-by-48 wave-
# misalignment band as every prior rung of this family, sharing the
# mod-128=48 sub-class with K-1978 N=816 / K-2071-K-2085 N=1200 /
# K-2150 N=1584 (4th independent confirmation of the mod-128=48 sub-cycle
# admit; per K-2150 R-K2150.MOD-64-IS-BINDING-MOD-128-IS-NOT, only
# `mod 64 == 48` binds — all four mod-128 sub-classes {16, 48, 80, 112}
# admit identically).  The K-COMPLEMENT swap recovers wave-tile coverage
# at residue-48 by reorienting the inner-K reduction so the per-tile
# schedule no longer strands a 48-element wave-misaligned N-fragment per
# BLOCK_N=128 tile (N=1840 = 14.375 fractional tiles per N-row, vs
# N=1776's 13.875 / N=1712's 13.375 / N=1648's 12.875 / N=1584's 12.375).
#
# Mechanism (R-1811 wave-misalignment + K-913 §3 LDS-bank-conflict): same
# SCHEDULER_LDS A4 failure mode as every prior off-by-48 rung; per K-2061
# PMC delta-attribution residue-48 carries a stable LDS bank-conflict
# differential (~6×) vs residue-32 (~2×) and wave-aligned (~1×) at
# (M=4096, K=8192, bf16).  K-2164 PMC delta-attribution sweep at the
# residue-48 ladder upper-bound (N=1648..1840) already profiled N=1840
# and confirmed the LDS_BC_per_LDS_inst and LDS_WAIT_per_LDS_inst
# signatures (per-wave SQ_INSTS_LDS dominant) persist at this rung.
# K-2199 PMC delta-attribution at the residue-48 boundary (N=1840 focused
# 3-pass M={4096,8192}×K=8192×bf16) further confirmed the wave-misaligned
# LDS bank-conflict signature carries through the 16th rung.  K-2223
# paired n=30 HIP-graph hot-cache 3-engine bench (tb / hbl / rocblas) on
# the task-specified 8-cell verification cohort
# (M ∈ {4096,8192} × N=1840 × K ∈ {8192,16384} × {bf16,fp16}) extends
# the K-2203 15-rung wall-clock chain by one residue-48 step (+64 from
# N=1776 on the same residue-48 lattice).  The frozenset literal
# cardinality (==8) matches the measured verification cohort, not the
...
# shared N).  +2 active LOC additive in the dispatcher (1 import in
# matmul.py + 1 membership-check); cold-path latency impact bounded by a
# single hash lookup (~30 ns on Zen3) per dispatch — equivalent to the 15
# prior off-by-48 rungs already in the alias-stack.
_K2223_P59_SKINNY_N1840_KCOMPL_ALIASSTACK_8 = frozenset(
    (M, 1840, K, dt) for M in (4096, 8192)
    for K in (8192, 16384) for dt in ("torch.bfloat16", "torch.float16")
)
