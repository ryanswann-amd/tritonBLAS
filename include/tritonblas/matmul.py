...
def matmul_a8w8(
    ...
    if _k648_should_override(M, N, K, a.dtype, enable_streamk):
        # K-648/K-692 gate: clamp to swept modal winner on the M=16 sub-cohort.
        # K-bucketed BK matches the K-624 pattern; everything else is
        # K-invariant on this sub-band.
