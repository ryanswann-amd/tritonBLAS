...
def _k971_route_to_hbl(M, N, K, a_dtype, b_dtype, enable_streamk, work_stealing):
    ...
    # K-1633 P27 18th-slot handle: no executable code — the K-1633-named
    # alias `_K1633_P27_SKINNY_N512_KCOMPL_ALIASSTACK_30` lives in
    # _route_predicate.py as a Python identity assignment of K-1552 P23,
