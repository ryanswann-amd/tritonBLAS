...
# Batched matrix multiply (``tritonblas.bmm``) lives in its own module — see
# ``include/tritonblas/bmm.py``.  It is re-exported from the package
# ``__init__`` so the public surface is unchanged.
