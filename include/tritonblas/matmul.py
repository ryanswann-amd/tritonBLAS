...
from ._route_predicate import (
    ...
    _k1367_p13_skinny_n128_kcomp_routeout as _R_K1367_P13_skinny_n128_kcomp_routeout,
)
...
def _k971_route_to_hbl(M, N, K, a_dtype, b_dtype, enable_streamk, work_stealing):
    ...
    # sub-frozensets via cross-frozenset asserts at module load.
    if _R_K1367_P13_skinny_n128_kcomp_routeout(int(M), int(N), int(K), a_dtype): return True
    return False
